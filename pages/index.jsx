  ...
  return (
    <div className={styles.div}>
      ...
      <div className={styles.frameParent13}>
        <div className={styles.frameParent14}>
          <div className={styles.parent6}>
            ...
            <div className={styles.div18}>1 / 13 قسم</div>
          </div>
          <div className={styles.frameParent15}>
            <div className={styles.frameParent16}>
              <div className={styles.frameParent17}>
                <div className={styles.parent7}>
                  <b className={styles.b8}>ايمان المسلم</b>
                  <div className={styles.div19}>
                    اتفقت جميع رسالات الأنبياء لأقوامهم على عبادة الله وحده لا
                    شريك له والكفر بما يعبد من دون الله وهذا هو حقيقة ......
                  </div>
                </div>
                <img
                  className={styles.frameChild16}
                  alt=""
                  src="/rectangle-22526@2x.png"
                />
              </div>
              <div className={styles.frameParent18}>
                <div className={styles.parent8}>
                  <b className={styles.b8}>صيام المسلم</b>
                  <div className={styles.div20}>
                    فرض الله على المسلمين الصيام شهراً واحداً في السنة، هو شهر
                    رمضان المبارك، وجعله الركن الرابع من أركان ...........
                  </div>
                </div>
                <img
                  className={styles.frameChild16}
                  alt=""
                  src="/rectangle-22527@2x.png"
                />
              </div>
              <div className={styles.frameParent18}>
                <div className={styles.parent9}>
                  <b className={styles.b8}>طهارة المسلم</b>
                  <div className={styles.div21}>
                    امر الله المسلم بتطهير قلبه وباطنه من الشرك وأمراض القلوب
                    كالحسد والكبر والحقد ، وتطهير ظاهره من النجاسات .......
                  </div>
                </div>
                <img
                  className={styles.frameChild16}
              ...
              <div className={styles.frameParent18}>
                <div className={styles.parent9}>
                  <b className={styles.b8}>الزكاة</b>
                  <div className={styles.div22}>
                    فرض الله الزكاة، وجعلها الركن الثالث من أركان الإسلام، وتوعد
                    من تركها بالعقوبة الشديدة، وربط الأخوة مع ...............
                  </div>
                </div>
                <img
                  className={styles.frameChild16}
      ...
      <div className={styles.parent12}>
        <div className={styles.div24}>{`استكشف المزيد `}</div>
